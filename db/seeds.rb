...
Task.create([{description: 'Take a dog for a walk', reward: 4, state: 'in progress', user_id: 1},
             {description: 'Plant something in the garden', reward: 5, state: 'in progress', user_id: 1},
             {description: 'Wash a real car', reward: 6, state: 'in progress', user_id: 2},
             {description: 'Play with a ball', reward: 1, state: 'in progress', user_id: 3},
